...
if not _descriptor._USE_C_DESCRIPTORS:
  ...
  _globals['_EXECUTORSERVICE']._serialized_end=634
  _globals['_HELLOSERVICE']._serialized_start=636
  _globals['_HELLOSERVICE']._serialized_end=711
